...
export default function StockDetailPage() {
  ...
  const { amount, shares, handleAmountChange, handleSharesChange, handleBuyStock, handleSellStock, handleSellPercentage } = useStockTransactions({ 
    stock: combinedStock, 
    credit, 
  ...
  const priceChangeColor = (combinedStock.priceChange >= 0 || combinedStock.price > combinedStock.previousPrice) 
    ? "text-success" 
    : "text-error";
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="w-full md:w-8/12 bg-base-100 rounded-xl shadow-xl p-4 md:p-6">
            ...
            {combinedStock.website && (
              <div className="mt-3">
                <a href={combinedStock.website} target="_blank" rel="noopener noreferrer" className="link link-primary text-sm">
                  Sitio web oficial
                </a>
              </div>
            )}
