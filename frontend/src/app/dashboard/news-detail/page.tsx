...
export default function NewsDetailPage() {
  ...
  const fetchOtherNews = async (symbol) => {
    ...
    try {
      const response = await fetch(`http://localhost:4000/api/market/news?symbol=${symbol}`, {
        method: "GET",
        credentials: "include",
      });
  ...
  if (!article) {
    return (
      <div className="min-h-screen flex justify-center items-center">
        <p>No hay datos de la noticia.</p>
      </div>
    );
  }
    ...
    <div className="container mx-auto p-4 md:p-6 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2">
          <div className="card bg-base-100 shadow-xl">
            ...
            <div className="card-body">
              ...
              {article.description && <p className="mt-4">{article.description}</p>}
        ...
        <div>
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <h3 className="card-title">Otras noticias de {symbolFromQuery}</h3>
              {loadingOther ? (
                ...
                <div className="overflow-y-auto max-h-96">
                  {otherNews && otherNews.length > 0 ? (
                    ...
                    <p className="text-sm text-gray-500">No hay otras noticias.</p>
                  )}
                </div>
              )}
            </div>
