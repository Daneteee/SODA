...
export default function AboutPage() {
  return (
    <div className="relative min-h-screen bg-base-200 overflow-hidden">
      {/* Fondo con burbujas animadas (igual que en la página de cookies) */}
      ...
      {/* Hero Section con estilo similar a la página de cookies */}
      <section className="py-20 px-6 bg-gradient-to-br from-primary/40 to-accent/40 text-center relative z-10">
        <div className="container mx-auto">
          <Info className="mt-10 w-20 h-20 mx-auto mb-6 text-white/90" />
          <h1 className="text-5xl font-bold mb-6 text-white drop-shadow-[0_0_25px_rgba(255,255,255,0.4)]">
            Descubre SODA
          </h1>
          <p className="text-xl text-white/80 max-w-3xl mx-auto">
            La plataforma de inversión más completa que combina datos de mercado en tiempo real, noticias financieras y
            una comunidad activa para ayudarte a tomar mejores decisiones de inversión.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300">
              <div className="card-body items-center text-center">
                ...
                <p>
                  Accede a datos de mercado en tiempo real con actualizaciones instantáneas de precios, gráficos
            ...
            <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300">
              <div className="card-body items-center text-center">
                ...
                <p>
                  Mantente informado con las últimas noticias sobre empresas, análisis de expertos y eventos que afectan
                  a tus inversiones.
                </p>
              </div>
            </div>
            ...
            <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300">
              <div className="card-body items-center text-center">
                ...
                <p>
                  Herramientas avanzadas para seguir y analizar tu cartera, con métricas de rendimiento y
            ...
            <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300">
              <div className="card-body items-center text-center">
                ...
                <p>
                  Conecta con otros inversores, comparte estrategias y participa en discusiones en tiempo real sobre el
                  mercado.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-lg">
                  Nuestros datos se actualizan al instante, permitiéndote reaccionar rápidamente a los cambios del
                  mercado y tomar decisiones informadas en el momento oportuno.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-lg">
                  Diseñada pensando en la experiencia del usuario, nuestra plataforma es fácil de usar tanto para
                  principiantes como para inversores experimentados.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-lg">
                  Herramientas de análisis técnico y fundamental que te ayudan a entender el rendimiento pasado y
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-lg">
                  Forma parte de una comunidad vibrante de inversores que comparten conocimientos, estrategias y apoyo
                  mutuo.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="card bg-base-200 shadow-xl">
              <div className="card-body">
                ...
                <p className="italic">
                  "SODA ha transformado mi forma de invertir. Los datos en tiempo real y las noticias me permiten
                  tomar decisiones más informadas. ¡Mi cartera ha crecido un 30% desde que empecé a usar la plataforma!"
                </p>
            ...
            <div className="card bg-base-200 shadow-xl">
              <div className="card-body">
                ...
                <p className="italic">
                  "Como trader profesional, necesito herramientas rápidas y fiables. SODA ofrece exactamente eso,
                  con una interfaz intuitiva y datos precisos. La comunidad es un gran valor añadido para compartir
                  estrategias."
                </p>
                <div className="flex mt-4">
                  <CheckCircle className="text-success w-5 h-5 mr-1" />
            ...
            <div className="card bg-base-200 shadow-xl">
              <div className="card-body">
                ...
                <p className="italic">
                  "Empecé a invertir hace poco y SODA ha sido mi guía. La plataforma es fácil de usar y la
                  comunidad me ha ayudado a aprender rápidamente. Las noticias y análisis son perfectos para entender el
                  mercado."
                </p>
                <div className="flex mt-4">
                  <CheckCircle className="text-success w-5 h-5 mr-1" />
      ...
      <section className="py-20 px-6 bg-primary text-primary-content">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto mb-10">
            Comienza hoy mismo a tomar mejores decisiones de inversión con datos en tiempo real, noticias actualizadas y
            una comunidad activa de inversores.
          </p>
